  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      if (foundInterview && foundInterview.status === "completed") {
        ...
        console.log(
          "foundInterview",
          foundInterview.report.generated_report.aiAnalysis
        );
      ...
      <DashboardLayout title="Interview Reports">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-1 p-4">
            ...
            {interviews
              .filter((i) => i.status === "completed" && i.id != "2")
              .slice(0, 5)
              .map((i) => (
                <div
                  key={i.id}
      ...
      <div className="mb-4 flex justify-between items-center">
        <div>
          ...
          <div className="text-gray-500">
            Interview conducted on {formatDate(interview.date)}
          </div>
        </div>
        <Button onClick={handleDownloadReport} disabled={loadingPdf}>
          {loadingPdf ? (
            <>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {interview.feedback?.technicalRating}/5
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${
                        (interview.feedback?.technicalRating || 0) * 20
                      }%`,
                    }}
                  ></div>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {interview.feedback?.communicationRating}/5
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${
                        (interview.feedback?.communicationRating || 0) * 20
                      }%`,
                    }}
                  ></div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-700">
                        {interview.report.generated_report?.summary ||
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <ul className="space-y-2">
                          {(
                            interview.report.generated_report?.strengths || []
                          ).map((strength, i) => (
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {(
                            interview.report.generated_report?.weaknesses || []
                          ).map((weakness, i) => (
                            <li key={i} className="flex items-start">
            ...
            <TabsContent value="ai-analysis">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    AI-powered assessment of the interview
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                      ...
                      <p className="text-gray-700">
                        {interview.report.generated_report?.aiAnalysis ||
                          "AI analysis not available."}
                      </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {interview.report.generated_report?.otherAspect &&
                        Object.values(
                          interview.report.generated_report.otherAspect
                        ).map((aspect, index) => (
                          <Card key={index}>
            ...
            <TabsContent value="feedback">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Detailed feedback provided by the interviewer
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="font-medium">
                              {interview.feedback?.technicalRating === 5
                                ...
                                ? "Very Good"
                                : interview.feedback?.technicalRating === 3
                                ? "Good"
                                : interview.feedback?.technicalRating === 2
                                ? "Fair"
                                : "Poor"}
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="font-medium">
                              {interview.feedback?.communicationRating === 5
                                ...
                                ? "Very Good"
                                : interview.feedback?.communicationRating === 3
                                ? "Good"
                                : interview.feedback?.communicationRating === 2
                                ? "Fair"
                                : "Poor"}
                            </div>
                          </div>
