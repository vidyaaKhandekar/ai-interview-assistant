...
const scheduleInterviewSchema = z.object({
  ...
  candidatePhone: z.string().min(7, { message: 'Please enter a valid phone number' }),
...
const ScheduleInterview: React.FC = () => {
  ...
  const [scheduledInterview, setScheduledInterview] = useState<InterviewType | null>(null);
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <h3 className="text-lg font-medium text-blue-800 mb-4">Interview Details</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium text-gray-600">Candidate:</p>
                  <p className="text-gray-800 font-medium">{scheduledInterview.candidateName}</p>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => {
                      navigator.clipboard.writeText(scheduledInterview.interviewerLink || '');
                ...
                <p className="text-sm text-gray-500 mt-1">Use this link to join as the interviewer</p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => {
                      navigator.clipboard.writeText(scheduledInterview.candidateLink || '');
                ...
                <p className="text-sm text-gray-500 mt-1">Share this link with the candidate</p>
              </div>
            </div>
          </CardContent>
